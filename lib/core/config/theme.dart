...
class AppTextStyles {
  ...
  /// 转换为 Flutter TextTheme
  ///
  /// 映射关系:
  /// - displayLarge -> Display (32px, bold)
  /// - headlineLarge -> H1 (26px, medium)
  /// - headlineMedium -> H2/Title1 (24px, medium)
  /// - titleLarge -> Title2 (20px, medium)
  /// - titleMedium -> Body Medium (16px, regular)
  /// - bodyLarge -> Body (14px, regular)
  /// - bodyMedium -> Caption (12px, regular)
  /// - bodySmall -> Tiny (10px, regular)
