...
require_grep "lib/application/providers/global_provider.dart" .github/workflows/nightly-loong64.yml
...
require_grep 'LINGLONG_RELEASE_TOOL_ROOT="$ROOT_DIR"' build/scripts/render-packaging-templates.sh
