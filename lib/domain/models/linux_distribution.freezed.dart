...
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? displayName = null,Object? capabilities = null,}) {
  return _then(LinuxDistribution(
...
class _LinuxDistribution extends LinuxDistribution {
  const _LinuxDistribution({this.id = LinuxDistributionId.unknown, this.displayName = '',  List<LinuxDistributionCapability> capabilities = const <LinuxDistributionCapability>[]}): _capabilities = capabilities,super._();
