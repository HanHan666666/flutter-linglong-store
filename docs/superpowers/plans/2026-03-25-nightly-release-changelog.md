...
- [x] **Step 1: Extend the nightly smoke test with release-notes assertions**
...
- [x] **Step 2: Run the nightly smoke test to verify it fails before implementation**
...
- [x] **Step 1: Create the generator script with strict inputs**
...
- [x] **Step 2: Re-run the nightly smoke test and confirm the script produces the expected content**
...
- [x] **Step 1: Expose the previous nightly source commit from the existing metadata lookup**
...
- [x] **Step 2: Replace inline heredoc note rendering with the generator script**
...
- [x] **Step 3: Verify workflow invariants remain intact**
...
- [x] **Step 1: Re-run focused verification after all code changes**
...
- [x] **Step 2: Update repo guidance only if a durable convention changed**
